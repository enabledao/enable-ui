...
const getInstance = async address => await getContractInstance(ERC20Detailed.abi, address);
...
const allowance = (instance, owner, spender) => contractMethodCall(instance, 'allowance', owner, spender);
const approve = (instance, recipient, amount, txOptions) => contractMethodTransaction(instance, 'approve', recipient, amount, txOptions);
