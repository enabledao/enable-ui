...
import { getDeployedFromConfig, getDeploymentBlockForContract } from "../../../utils/getDeployed";
...
class MyLoan extends React.Component<MyLoanProps, MyLoanState> {
    ...
    componentDidMount = async () => {
        try {
            ...
            const crowdloanFactoryInstance = await getDeployedFromConfig('CrowdloanFactory', contractAddresses);
            ...
            const fromBlock = await getDeploymentBlockForContract(crowdloanFactoryInstance, 'TermsContract', termsContractInstance.options.address);
