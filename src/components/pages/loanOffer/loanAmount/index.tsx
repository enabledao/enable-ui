...
class LoanAmount extends React.Component<LoanAmountProps, LoanAmountState> {
    ...
    simulateInterest = contribution => {
        ...
        return calcExpectedReturn(
            prepBigNumber(contribution, this.state.paymentToken.decimals),
            principalRequested,
            interestRate,
            expectedSalary,
            loanPeriod
        ...
        return (
            <StepLoanOfferWrapper>
                <Container>
                    ...
                    <p>
                        Lastly, please input the amount you're willing to lend
                    </p>
                    <Form
                                ...
                                <Row>
                                    ...
                                    <Col lg={6} md={12}>
                                        <LoanAmountSimulation>
                                            ...
                                            <p>
                                                You can expect to earn a total
                                                interest of:
                                            </p>
                                            <Margin vertical={24}>
                                                <h4>
                                            ...
                                            <p>
                                                ...
                                                agreeing to the disclaimer for
                                                simulate returns. Simulated
                                                return also does not count gas
                                                fees
                                            </p>
                                        </LoanAmountSimulation>
                                    </Col>
